    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "No se pudo cargar informacion desde Gestion Empresarial",
    };
  }
}
...
function getPosBlockedDescription(
  ...
  if (erpProvisioning.isSimulated) {
    return "La validacion tecnica termino, pero POS, inventario y reportes seguiran bloqueados hasta completar la activacion operativa.";
  }
  ...
  if (erpProvisioning.status === "not_configured") {
    return "El POS de Facturacion necesita productos, bodegas, clientes, metodos de pago e inventario desde Gestion Empresarial. Solicita primero la activacion correspondiente.";
  }

  return erpProvisioning.displayStatus;
}

export async function AdvancedPosPage() {
      ...
      <DashboardShell>
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Inicia sesion para usar el POS de Facturacion.
          </p>
        </div>
      </DashboardShell>
    );
      ...
      <DashboardShell>
        <div className="space-y-6">
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-tight">Gestion Empresarial no activa</h1>
    ...
    <DashboardShell>
      <div className="space-y-6">
        ...
        {resourceErrors.length > 0 ? (
          <Card>
            <CardHeader>
              <CardTitle>Revision de conexion de Gestion Empresarial</CardTitle>
            </CardHeader>
