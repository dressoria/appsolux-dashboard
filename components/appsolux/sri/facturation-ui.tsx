...
export function FacturationStatusBadge({
  label,
  variant = "neutral",
}: {
  label: string;
...
export function FacturationMetricCard({
  icon: Icon,
  label,
  value,
  helper,
...
export function FacturationQuickAction({
  href,
  title,
  description,
  icon: Icon,
...
export function FacturationSummaryPanel({
  title,
  description,
  primaryHref,
  primaryLabel,
